...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/yasmin-santos-ofc-20558b34b?utm_source=share_via&utm_content=profile&utm_medium=member_ios)
[![E-mail](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:yasminsantossolii@gmail.com)

---

### 👩‍💻 Sobre
Atualmente cursando Análise e Desenvolvimento de Sistemas na Universidade Cidade de São Paulo (Unicid). Apaixonada por resolver problemas através da tecnologia, com foco em desenvolvimento web e análise de dados.
...
| **SM9 - Desenvolvimento de App de Videoconferência com Manus AI e Jitsi** | Desenvolvimento de um aplicativo de videoconferência utilizando Manus AI e a plataforma Jitsi. | [Ver Projeto](./Desenvolvimento de App de Videoconferência com Manus AI e Jitsi/) |

### 🏗 Estrutura do Repositório

- `root/`: Arquivo de apresentação principal.
- `/projeto-nome/`: Código-fonte, documentação e README específico de cada projeto.
